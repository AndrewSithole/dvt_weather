...
const TextStyle minMaxTemperatureStyle = TextStyle(fontSize: 18, fontWeight: FontWeight.w500, color: Colors.white, letterSpacing: 3);
const TextStyle subTitleStyle = TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: Colors.white, letterSpacing: 3);